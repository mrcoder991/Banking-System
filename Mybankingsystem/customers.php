...
<head>
    ...
    <link href="./images/favicon.ico" rel="icon" type="text/css" />
...
<body style="background-color: #33859c">
<?php
    include 'config.php';
...
<div class="container">
            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : #bf2c8e;">Transfer money</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
        ...
        <footer class="text-center mt-5 py-2">
            <span>Created By <b>Pratiksha Ghadge</b> | <span class="far fa-copyright"></span> 2021 All rights
                reserved.</span>
        </footer>
